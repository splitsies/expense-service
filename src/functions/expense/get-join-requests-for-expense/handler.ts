...
import { HttpStatusCode, DataResponse, InvalidArgumentsError, IExpenseJoinRequest } from "@splitsies/shared-models";
...
export const main = middyfy(
    SplitsiesFunctionHandlerFactory.create<typeof schema, IExpenseJoinRequest[] | string>(
        ...
        async (event) => {
            ...
            if (!(await expenseService.getUserExpense(event.requestContext.authorizer.userId, expenseId))) {
